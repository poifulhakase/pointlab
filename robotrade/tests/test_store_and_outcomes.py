...
from robotrade import money
from robotrade.learning import outcomes
from robotrade.portfolio.portfolio import Portfolio
...
def test_order_decided_today_is_not_filled_today():
    ...
    **その日の寄り**で約定していた。「その日の終値まで見たうえでその日の始値で買う」
    ...
    """
    from robotrade.orchestrator import order_is_due
...
def test_already_ran_is_a_skip_but_not_an_error():
    ...
    from robotrade.orchestrator import AlreadyRan, SkipRun
