...
from swinglab.dashboard_data import DashboardData  # noqa: E402
from swinglab.learning import outcomes as outcomes_mod  # noqa: E402
from swinglab.notify.discord import tradingview_url  # noqa: E402
from swinglab.portfolio.store import Store  # noqa: E402
...
st.set_page_config(page_title="swing-lab", page_icon="📊", layout="wide")
...
def view_performance(data: DashboardData, cfg) -> None:
    ...
    if len(frame) >= 2 and frame["benchmark"].notna().any():
        ...
        indexed = pd.DataFrame({
            ...
            "swing-lab": frame["equity"] / frame["equity"].iloc[0] * 100,
