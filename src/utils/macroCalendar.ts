...
export const MACRO_META: Record<MacroEventType, {
  ...
  fomc:   { color: '#f59e0b', bg: 'rgba(245,158,11,0.28)',   short: 'FOMC',    label: 'FOMC（声明発表）',         category: 'us',
    desc: 'FRB（連邦準備制度理事会）が年8回開催する金融政策会合。政策金利の変更・維持を決定し声明文を発表。株・債券・為替すべてに大きな影響を与える。' },
  boj:    { color: '#f87171', bg: 'rgba(248,113,113,0.28)',  short: '日銀',    label: '日銀政策決定会合',         category: 'jp',
    desc: '日本銀行が年8回開催する金融政策決定会合。政策金利や資産買い入れ方針を決定。円相場・日本株に直接影響する。' },
  nfp:    { color: '#a78bfa', bg: 'rgba(167,139,250,0.28)', short: '雇用統計', label: '米雇用統計発表',           category: 'us',
    desc: '米労働省が毎月第1金曜日に発表する非農業部門雇用者数（NFP）。米国経済の健全性を示す最重要指標のひとつ。予想との乖離で相場が急変動しやすい。' },
  cpi:    { color: '#22d3ee', bg: 'rgba(34,211,238,0.28)',  short: 'CPI',     label: '米CPI（消費者物価指数）',  category: 'us',
    desc: '米労働省が発表する消費者物価指数。インフレの代表的指標でFRBの金融政策判断に直結。コアCPI（食品・エネルギー除く）も注目される。' },
  pce:    { color: '#34d399', bg: 'rgba(52,211,153,0.28)',  short: 'PCE',     label: '米PCE（個人消費支出）',    category: 'us',
    desc: 'FRBが最重視するインフレ指標。個人消費支出に含まれる物価変動を測定し、CPIより幅広い品目をカバー。FRBの目標インフレ率2%の基準となる。' },
  gdp:    { color: '#e879f9', bg: 'rgba(232,121,249,0.28)', short: 'GDP',     label: '米GDP速報値',              category: 'us',
    desc: '米商務省が四半期ごとに発表するGDP速報値。米国経済の成長率を示す最重要統計。景気後退（2四半期連続マイナス）の判断基準にもなる。' },
  tankan: { color: '#fb923c', bg: 'rgba(251,146,60,0.28)',  short: '短観',    label: '日銀短観',                 category: 'jp',
