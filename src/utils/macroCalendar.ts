...
const FOMC_DATES: [number, number, number][] = [
  ...
  // 2027（federalreserve.gov の公表日程で確認・2026-09-20）
  [2027, 0, 27], [2027, 2, 17], [2027, 3, 28], [2027, 5,  9],
  [2027, 6, 28], [2027, 8, 15], [2027, 9, 27], [2027, 11,  8],
]
...
const BOJ_DATES: [number, number, number][] = [
  ...
  // 2027（BOJ公式スケジュールで確認・2026-09-20）
  [2027, 0, 22], [2027, 2, 18], [2027, 3, 28], [2027, 5, 11],
  [2027, 6, 22], [2027, 8, 22], [2027, 9, 29], [2027, 11, 17],
]
