...
const NYSE_HOLIDAYS = [
  ...
  // 2027（NYSE公表・2026-09-20 に確認）
  // 🔵 週末にかかる3つは振替で休場になる:
  //    Juneteenth(6/19 土)→6/18(金) / 独立記念日(7/4 日)→7/5(月) / クリスマス(12/25 土)→12/24(金)
  [2027, 0,  1], [2027, 0, 18], [2027, 1, 15], [2027, 2, 26],
  [2027, 4, 31], [2027, 5, 18], [2027, 6,  5], [2027, 8,  6],
  [2027, 10, 25], [2027, 11, 24],
]
