    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          🔴 <b>これは「過去はこうだった」の記録であって、戦略が良いことの証明ではありません。</b>
          2026-08-22 の検証で、20年通しで基準を超えた規則が期間を前後半に割ると逆転すること、
          勝率の差を偶然と区別するには数千件が要ることが分かりました。
          <b>成績が良いことを採用の理由にしません</b>（統計は「却下」にだけ使う方針）。
          将来の成績や投資成果を示すものでもありません。
        </div>
