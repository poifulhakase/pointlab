...
const ARMS = [
  ...
  // 🔴 2026-08-16 に表示名を変更（シールド→ブンセキ／エンジン→ロボ口座・ユーザー指示）
  { code: 'ANALYSIS', ja: 'ブンセキ', desc: '複雑なクオンツ・需給データをAIプロンプトへ一瞬で錬成する。',              accent: '#00e5ff' },
  { code: 'MARGIN',   ja: 'ぽいロボ', desc: '信用買いが積み上がった期間と、その期日の目安をチャートにする。',          accent: '#60a5fa' },
...
const SECTIONS: Section[] = [
  ...
  {
    num:'07', ja:'錬成', en:'THE ANALYSIS',
    title:'膨大なデータを、一瞬で「弾薬」に変える。',
    paragraphs:[
      '先物建玉の変化、投資主体別の資金フロー、信用倍率の歪み。それらは単体では「情報」に過ぎない。',
      'ぽいロボ ブンセキは、それらをAIが即座に解析できる「構造化された弾薬」へと錬成する。',
      'インターフェースが、すべての手間を消し去る。あなたは、引き金を引くだけでいい。',
    ],
  },
  {
    // 🔴 2026-09-16：疑似トレード（その前はポジション分析）の説明のままだったので、信用期日に書き換えた
    num:'08', ja:'時期', en:'THE MARGIN CYCLE',
    title:'重しが外れる日は、暦に書いてある。',
    paragraphs:[
      '下げの中で積み上がった信用買いは、いずれ手放される。制度信用の期日は、6か月。',
      'ぽいロボは、信用買いが積み上がった週を記録し、その売りが出尽くす時期を暦の上に示す。',
      '重しが外れる時期を知っていれば、焦らずに待つことができる。',
    ],
  },
  {
