...
const ARMS = [
  ...
  { code: 'SHIELD',  ja: 'シールド', desc: '複雑なクオンツ・需給データをAIプロンプトへ一瞬で錬成する。',               accent: '#00e5ff' },
  { code: 'ENGINE',  ja: 'エンジン', desc: '証券口座の現実をシステムに直視させ、背中のリスクを徹底的に守る。',           accent: '#60a5fa' },
