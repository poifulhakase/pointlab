...
const CANDLES: Candle[] = [
  ...
  {
    name: '窓埋め', n: '窓', kind: 'neutral',
    says: '開けた窓まで値段が戻ってくること。埋めたあと再び進むか、そこで止まるかで意味が変わる。',
    how: '上昇なら前の足の高値まで戻れば埋まり。🔵 普通の窓はほぼ埋まる／放れの窓は埋めずに進みやすい／'
      + '尽きの窓は数日で埋まる。🔴 「窓は必ず埋まる」は**いつ埋まるかを言っていない**ので、それだけでは売買の根拠にならない。',
    bars: [
      { o: 34, h: 42, l: 30, c: 40 }, { o: 56, h: 68, l: 54, c: 66 },
      { o: 64, h: 70, l: 52, c: 54 }, { o: 52, h: 56, l: 40, c: 44 }, { o: 44, h: 62, l: 42, c: 58 },
    ],
    gapAt: 1,
  },
  {
