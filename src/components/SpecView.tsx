    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          'フローティングサブバー（右下 position:fixed zIndex: 150）: カレンダー(月/週/日)・チャート(銘柄)・エンジン(エンジン/環境/現物/先物)・シールド(シールド/イベント)・LegalModal(プライバシー/免責事項/利用規約)でタブ表示。各ビューのアクティブタブを右下 pill で切り替え（★2026-05-27 シールドタブ・LegalModalタブ追加、「分析」→「エンジン」改称、「ニュース」→「イベント」改称。★2026-06-05 LegalModal に利用規約タブ追加）',
