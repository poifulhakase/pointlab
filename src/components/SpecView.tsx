...
const SPEC_SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'list' as const,
        heading: 'TEVバックテスト（BacktestPanel）★2026-05-26',
        items: [
          '研究室 > 資料 > 「TEV バックテスト」カードからアクセス（一般ユーザーも閲覧可）',
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['資料', 'NoteView — 記事一覧（基礎・インジケーター・イベントドリブン・未来ガジェット）。特殊カード: TEVバックテスト（一般ユーザーも閲覧可）/ プロンプト Evals（管理者のみ）。「← 研究室」ボタンで研究室へ戻れる'],
