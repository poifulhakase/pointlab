    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          '全13スライド・2部構成に拡張: 第1部=運用〔全体像／1週間の流れ(土曜起点)／ぽいロボ レーダー(カレンダー＋前日通知)／ぽいロボ エンジン／ぽいロボ シールド／ぽいロボ コネクト〕＋第2部=取引〔やること3つ／長期投資と何が違う？／勝てる4つの理由／応用A+B／安全に回すコツ／最後に大事なこと〕。道具スライドはアプリ準拠アイコン(CalendarHeaderと同一SVG・コネクトはhakase.webp)＋使い方動画の16:9埋め込み枠(プレースホルダー・後でiframe/動画を差込)',
