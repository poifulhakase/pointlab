    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          '★2026-05-29 対応済み: Vitest 86テスト（sqCalendar / macroCalendar / dataCache / noteStorage / marketHolidays / anomalyCalendar / dividendCalendar）/ 全lazy ビュー（10ビュー）にErrorBoundary適用＋Sentry自動上報',
