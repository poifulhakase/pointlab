    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          '🔵 **DATA→未来ガジェット→フォーメーション分析（★2026-08-11 新設）**＝チャートパターン16種をSVGで図示（線が描かれる演出つき）。🔴 主張は「パターンを覚えよう」ではなく、**26年の日経で測ったら方向すら安定しなかった**という実測を併記すること。三尊は9通りの定義で先20日が +1.15% 〜 −1.34% とバラバラ。ダブルボトムだけが9通りすべてプラスだが基準(t≧2)は1通りのみ。未測定のものは「未測定」と書き、効くとも効かないとも書かない。ヘッダーはタイムマシンと同形、立場と測り方は ? に畳んである',
