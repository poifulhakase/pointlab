    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          '確信度の再キャリブレーション（★2026-06-10・tevCore.mjs）: 上記の自信過剰を受け、確信度の式を傾き0.5→0.3・上限95→70に圧縮（範囲50〜70%）。enginePrompt の確信度バンド閾値も 弱い〜59/明確60-69/強い共振70 に再設定。⚠シグナル方向は確信度非依存のため勝率（44%）は不変。⚠さらに判明＝確信度は単なる定数の過信でなく「高確信度ほど実勝率が下がる反転傾向」（70%台4週で実勝率25%）。強い一方向の需給＝行き過ぎ＝反転の罠というR&D結論と整合。n=27と小標本のため反転の打ち消し（フィッティング）はせず、過信を削るシュリンクに留めた。最終解は更なるデータ蓄積で判断',
