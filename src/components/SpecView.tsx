    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          '🔴 **トレーリングストップ（★2026-08-11・積極化）**＝毎営業日、終値から ATR20×倍率の位置へ損切りを引き上げる。**上げるだけで下げない・利確ルールは入れない**。この戦略は勝率34〜40%が正常で期待値は大きな勝ちを取り切れるかで決まるため、早めに利確する余地を仕組みで塞いだ。引き上げは損切り確認の**後**に行う（今日引き上げた線が効くのは明日から）。`trailStop`（純関数）＋`applyTrail`。レバや確信度連動の建玉倍率は採らない（DDを増やす／確信度は実測で反転）',
