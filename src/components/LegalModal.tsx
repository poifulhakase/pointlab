  ...
  },
  {
    ...
    content: [
      { type: 'list', heading: 'ブラウザのローカルストレージ', items: [
        'カレンダーメモ、スティッキーメモ、アプリ設定、登録チャンネルリスト、市場データのキャッシュ等をブラウザのローカルストレージに保存します。',
      ...
      { type: 'list', heading: 'Google アカウント（任意）', items: [
        ...
        'Firestore データベースにカレンダーメモ・スティッキーメモ・チャンネルリストを保存し、複数デバイス間の同期に使用します。',
