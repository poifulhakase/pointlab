...
const MAXIMS: Maxim[] = [
  ...
  },
  {
    ...
    text: '需給はすべてに優先する',
    source: '相場格言',
    meaning: 'どんな好材料・悪材料があっても、最終的に株価を動かすのは買い手と売り手の力関係（需給）。材料は需給に翻訳されて初めて値段になる。',
    apply: 'ニュースの良し悪しより、誰がどれだけ買い・売りに傾いているかを見る。需給こそが価格の最終決定者。',
  },
  {
    id: 'mochiai',
    text: 'もち合い放れにつけ',
    source: '相場格言',
    meaning: '買いと売りが拮抗して動かない「もち合い」が、どちらかに放れた（崩れた）時は、その方向に大きなエネルギーが出やすい。',
    apply: '均衡が崩れて放れた方向についていく。レンジ内での逆張りより、放れの初動を取る。',
  },
  {
    id: 'age100',
    text: '上げ百日、下げ十日',
    source: '相場格言',
    meaning: '買いは時間をかけてじわじわ積み上がる（上げ百日）が、売り（投げ）は恐怖で一気に出る（下げ十日）。需給の非対称性を表す。',
    apply: '上昇はゆっくり、下落は速いと心得る。だからこそ下げの初動では素早く身を守る。',
  },
]
