...
const SECTIONS = [
  ...
  },
  {
    ...
    title: 'データ（需給分析）',
    items: [
      'ナビバーのロボットアイコンから表示。環境・現物需給・先物需給の3タブ構成です。',
      '【環境】VIX・NS倍率チャートと、クオンツ分析レポート（AIへのメモ帳）を表示します。',
      '【現物需給】信用倍率・投資主体別売買動向・需給指標（騰落レシオ・空売り比率・裁定買い残）を表示します。',
      '【先物需給】投資部門別（外国人・信託銀行・生命保険・投資信託・個人・証券会社）の先物ネット枚数・売り圧力スコアと先物OI（建玉残高推移）を表示します。',
