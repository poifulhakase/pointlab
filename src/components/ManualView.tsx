...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items:[
      ...
      '【先物】海外投機筋（ヘッジファンド）の日経225先物ポジション（週次）と売り圧力スコア、建玉残高・出来高・PCR（プット/コール比、オプション市場の強気・弱気の目安）の日次テーブルを表示します。PCR が 1.2 以上は赤（弱気）、0.8 以下は緑（強気）で色付けされます。',
    ],
  },
  {
    title: 'シールド（ポジション管理）',
  ...
  },
  {
    ...
    items:[
      ...
      '「資料」では記事や解説資料を読めます。資料を開いた後、右上の「×」ボタンを押すと資料一覧に戻ります。',
