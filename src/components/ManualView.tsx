...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      'テキストメモ・チェックリストのほか、開始〜終了時刻とタイトル付きのスケジュールを複数追加できます。タイトル未入力のまま閉じると、空のスケジュールは自動的に破棄されます。',
  ...
  },
  {
    ...
    items: [
      ...
      '「SETTINGS」では、テーマ（ライト/ダーク）の切り替えや、Google アカウントでのログイン/ログアウトができます。設定モーダルは研究室の SETTINGS ボタンからのみ開きます。',
