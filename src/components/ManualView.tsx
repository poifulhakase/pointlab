...
const SECTIONS: Section[] = [
    ...
    subs: [
      ...
      },
      {
        ...
        items: [
          ...
          'ログイン後はプッシュ通知を ON にできます。「ぽいロボ レーダー」（選択イベントの前日 12:30 に通知）と「データ更新通知」（週次データ更新後に通知）を個別に ON/OFF できます。',
        ],
      },
      {
        subtitle: 'お問い合わせ',
  ...
  },
  {
    ...
    items: [
      ...
      'ぽいロボは金融商品取引業（投資助言・代理業を含む）の登録を受けておらず、特定の銘柄等についての売買の助言やシグナルの配信は行いません。エンジン・シールド・戦略プレイブックなどが示す指標・判定・手法は、過去データにもとづく客観的な情報および教育であり、売買の推奨ではありません。',
