...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '【先物】投資部門別（外国人・信託銀行・生命保険・投資信託・個人・証券会社）の先物ネット枚数（週次）・売り圧力スコアを左2/3に、建玉残高・取引高の統合テーブル（日次）を右1/3に表示します。',
  ...
  },
  {
    ...
    title: 'AI分析プロンプト',
    items: [
      'データビュー右上の「ぽいロボエンジン（CPUアイコン）」ボタン →「プロンプト＋データをコピー」を押します。',
      'クリップボードにコピーされたテキストを Gemini に貼り付けるだけです。',
