...
export type ViewMode = 'month' | 'week' | 'day' | 'chart' | 'quant' | 'youtube' | 'note' | 'spec' | 'legal'

const VIEW_STORAGE_KEY = 'poical-view'
const VALID_VIEWS: ViewMode[] = ['month', 'week', 'day', 'chart', 'quant', 'youtube', 'note', 'spec', 'legal']
