...
const EXPECT = [
  ...
  // 🆕 2026-09-16：全銘柄の信用残の蓄積（ロボ口座＝信用期日）。🔴 JPXは直近5週しか公開しないので、
  //    止まったまま5週たつと**その週は二度と取れない**。margin.json と同じ許容で早めに気づく。
  { file: 'margin_weekly/index.json', maxAgeDays: 15, label: '信用残の週次蓄積（全銘柄）' }, // 公表ラグ5 + 行間隔7
