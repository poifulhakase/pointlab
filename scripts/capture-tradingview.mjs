...
//
// 🔴 **平日14:30に撮る**（2026-08-17 にユーザー判断で 16:00 から前倒し）。
//    それまで撮影は16:00、判断は15:00で、**判断より撮影が後**だった。
//    つまり AI は毎日「前営業日のチャート」を見ており、通知にも
//    「チャート画像が2営業日前のものです」と出続けていた（金→月は暦日で2日のため）。
//    🔵 前倒しの代償＝**大引け前のザラ場の足**になる（当日の終値は確定していない）。
//       それでも「当日の値動きを見せる」方を採る、というユーザー判断（2026-08-17）。
