...
(function () {
  ...
  function addFallback(img) {
    ...
    img.onerror = function () {
      var src = this.src || "";
      if (src.indexOf(".png") !== -1 && !this.dataset.triedJpg) {
        this.dataset.triedJpg = "1";
        this.src = src.replace(/\.png$/i, ".jpg");
      } else if (src.indexOf(".jpg") !== -1 && !this.dataset.triedPng) {
        this.dataset.triedPng = "1";
        this.src = src.replace(/\.jpg$/i, ".png");
      } else {
